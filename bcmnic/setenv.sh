...
if [ "$1" == 4323 ] ; then
	...
	export CHIPVER=43569a2
	echo "using ${CHIPVER}"
elif [ "$1" == 43570a2 ] ; then
	export CHIPVER=43570a2
	echo "using ${CHIPVER}"
elif [ "$1" == 43602a1 ] ; then
	export CHIPVER=43602a1
	echo "using ${CHIPVER}"
elif [ "$1" == 4366b1 ] ; then
	export CHIPVER=4366b1
	echo "using ${CHIPVER}"
else
	echo ""
	echo "==========================================="
	...
	echo "source setenv-xxx.sh 43569a2"
	echo "source setenv-xxx.sh 43570a2"	
	echo "source setenv-xxx.sh 43602a1"
	echo "source setenv-xxx.sh 4366b1"
