 ...
 *
 * $Id: wlc_msch.h 641658 2016-06-03 21:16:05Z $
 */
...
/* helper, calculates time duration in msch channel switch */
uint32 wlc_msch_calc_avg_chswtime(wlc_msch_info_t *msch_info, chanspec_t to);
