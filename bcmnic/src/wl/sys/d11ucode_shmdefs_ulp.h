 ...
 *
 * $Id: /projects/ucode_group_ext/work/patrick/05_wowl/96_branch_1177_102/d11ucode/d11ucode_shmdefs_ulp.h Sep. 09, 2016 07:00:32 PM <yup> $
 */
// COMMON SHMS
...
#define	M_DS1_SCR_SAVE_BLK	(0xdc4*2)
#define	M_DS1_SCR_SAVE_BLK_SIZE	64
#define	M_NON_FCBS_EXIT_DEBUG	(0xe04*2)
#define	M_NON_FCBS_EXIT_DEBUG_CMD_PTR	(0xe05*2)
#define	M_NON_FCBS_EXIT_DEBUG_DAT_PTR	(0xe06*2)
#define	M_FCBS_EXIT_DEBUG	(0xe07*2)
#define	M_FCBS_EXIT_DEBUG_CMD_PTR	(0xe08*2)
#define	M_FCBS_EXIT_DEBUG_DAT_PTR	(0xe09*2)
#define	M_ONE_TIME_CFG_BM	(0xe0a*2)
#define	M_DSX_TST_MODE	(0xe0b*2)
#define	M_FRRUN_LBCN_CNT	(0xe0c*2)
#define	M_DS1_KA_CFG	(0xe0d*2)
#define	M_DS1_KA_CTR	(0xe0e*2)
#define	M_DS1_KA_NUM	(0xe0f*2)
#define	M_DS1_KA_IPG	(0xe10*2)
#define	M_DS1_CTRL_STATUS	(0xe11*2)
#define	M_DS1_CTRL_SDIO	(0xe12*2)
#define	M_DS1_CTRL_SDIO_OOB_H	(0xe13*2)
#define	M_DS1_CTRL_SDIO_OOB_L	(0xe14*2)
#define	M_DS1_CTRL_SDIO_OOBTH	(0xe15*2)
#define	M_DS1_CTRL_JTAG	(0xe16*2)
#define	M_DS1_CTRL_JTAG_OOB_H	(0xe17*2)
#define	M_DS1_CTRL_JTAG_OOB_L	(0xe18*2)
#define	M_DS1_CTRL_JTAG_OOBTH	(0xe19*2)
#define	M_DS1_CTRL_SDIO_PIN	(0xe1a*2)
#define	M_DS1_CTRL_JTAG_PIN	(0xe1b*2)
#define	M_DS1_CTRL_FUNCAL	(0xe1c*2)
#define	M_DS1_ENTER_OOBJ	(0xe1d*2)
#define	M_DS1_DIS_OOBJ	(0xe1e*2)
#define	M_HUDI_DS1SLP_CTR	(0xe1f*2)
#define	M_JTAG_DS1SLP_CTR	(0xe20*2)
#define	M_HUDI_MNPOLL_CTR	(0xe21*2)
#define	M_HUDI_PM_CTR	(0xe22*2)
#define	M_HUDI_NO_ACTION	(0xe23*2)
...
#define	M_AWK_RSN_CD	(0xe24*2)
#define	M_AWK_RSN_CTRL	(0xe25*2)
#define	M_SLP_ACT_TSF_L	(0xe26*2)
#define	M_SLP_ACT_TSF_ML	(0xe27*2)
#define	M_PSM_LOGGER_BLK	(0xe28*2)
