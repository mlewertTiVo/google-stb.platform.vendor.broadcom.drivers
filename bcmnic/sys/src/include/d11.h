 ...
 *
 * $Id: d11.h 613490 2016-01-19 06:05:27Z $
 */
...
#define M_AC_TXLMT_BASE_ADDR(x)         (0x180 * 2)
#define M_AC_TXLMT_ADDR(x, _ac)         (M_AC_TXLMT_BASE_ADDR(x) + (2 * (_ac)))
...
#define M_PKTENG_MODE_TX(x)		0x0001
#define M_PKTENG_MODE_RX(x)		0x0002
#define M_PKTENG_MODE_RX_WITH_ACK(x)	0x0402
#define M_PKTENG_FRMCNT_VLD(x)		0x0100	/**< TX frames indicated in the frmcnt reg */
...
#define M_PWRIND_MAP4(x)	(M_PWRIND_BLKS(x) + 0x8)
#define M_PWRIND_MAP5(x)	(M_PWRIND_BLKS(x) + 0xa)
...
#define M_BTCX_AGG_OFF_BM		(0x7c * 2)
...
#define DEFAULT_FIFO0_STSLEN    0x1c	/* status length in default mode */
...
#define M_55f_REG_VAL(x)					16
#define	M_RSP_PCTLWD(x)			(0x011 * 2)

/* extended beacon phyctl bytes for 11N */
#define M_BCN_PCTL1WD(x)           (0x058 * 2)
