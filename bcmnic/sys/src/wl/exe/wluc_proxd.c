...
static void ftm_unpack_and_display_session_flags(uint8 *p_data, uint16 tlvid);
static void ftm_unpack_and_display_config_flags(uint8 *p_data, uint16 tlvid);
...
static void
ftm_unpack_and_display_session_flags(uint8 *p_data, uint16 tlvid)
{
...
static void
ftm_unpack_and_display_config_flags(uint8 *p_data, uint16 tlvid)
{
