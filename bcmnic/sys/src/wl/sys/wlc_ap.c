 ...
 *
 * $Id: wlc_ap.c 612761 2016-01-14 23:06:00Z $
 */
...
static const bcm_iovar_t wlc_ap_iovars[] = {
	...
	{"wowl_pkt", IOV_WOWL_PKT, 0, IOVT_BUFFER, 0},
	{NULL, 0, 0, 0, 0 }
};
...
BCMATTACHFN(wlc_ap_attach)(wlc_info_t *wlc)
{
	...
	appvt->as_scb_handle = wlc_scb_cubby_reserve_ext(wlc, sizeof(wlc_assoc_req_t *),
		wlc_as_scb_init, wlc_as_scb_deinit, wlc_as_scb_secsz, NULL, appvt);
	...
	appvt->ap_scb_handle = wlc_scb_cubby_reserve_ext(wlc, sizeof(ap_scb_cubby_t *),
		wlc_ap_scb_init, wlc_ap_scb_deinit, wlc_ap_scb_secsz, NULL, appvt);
...
#if defined(BCMDBG_ERR) || defined(WLMSG_ASSOC) || defined(WLMSG_BTA)
...
wlc_ap_acs_update(wlc_info_t *wlc)
{
	...
	wlc_set_chanspec(wlc, appvt->chanspec_selected);
	if (AP_ENAB(wlc->pub)) {
