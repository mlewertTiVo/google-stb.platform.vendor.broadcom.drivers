 ...
 *
 * $Id: wlc.h 613337 2016-01-18 18:45:51Z $
 */
...
/* ========== DON"T add new fields after this line =========== */
};
...
extern bool _wlc_prec_enq(wlc_info_t *wlc, struct pktq *q, void *pkt, int prec, const char *func);
#define wlc_prec_enq(wlc, pq, pkt, prec) \
	_wlc_prec_enq(wlc, pq, pkt, prec, __FUNCTION__)
extern bool _wlc_prec_enq_head(wlc_info_t *wlc, struct pktq *q, void *pkt, int prec, bool head,
	const char *func);
#define wlc_prec_enq_head(wlc, pq, pkt, prec, head) \
	_wlc_prec_enq_head(wlc, pq, pkt, prec, head, __FUNCTION__)
...
void wlc_ref_tick_us_init(wlc_info_t *wlc);
