...
FEATURE_BEGIN[btcx]
	M_BTCX_BLK_PTR
	M_BTCX_PRED_PER_OFFSET
	M_BTCX_LAST_SCO_OFFSET
	M_BTCX_LAST_SCO_H_OFFSET
	M_BTCX_NEXT_SCO_OFFSET
	M_BTCX_REQ_START_OFFSET
	M_BTCX_LAST_DATA_OFFSET
	M_BTCX_BT_TYPE_OFFSET
	M_BTCX_LAST_A2DP_OFFSET
	M_BTCX_PRI_MAP_LO_OFFSET
	M_BTCX_HOLDSCO_LIMIT_OFFSET
	M_BTCX_SCO_GRANT_HOLD_RATIO_OFFSET
	M_BTCX_PRED_COUNT_OFFSET
	M_BTCX_PROT_RSSI_THRESH_OFFSET
	M_BTCX_HOST_FLAGS_OFFSET
	M_BTCX_RSSI_OFFSET
	M_BTCX_HIGH_THRESH_OFFSET
	M_BTCX_LOW_THRESH_OFFSET
	M_BTCX_CONFIG_OFFSET
	M_BTCX_BT_TXPWR_OFFSET
	M_BTCX_NUM_TASKS_OFFSET
	M_BTCX_REQ_START_H_OFFSET
	M_BTCXDBG_BLK
	M_BTCX_RFSWMSK_BT_OFFSET				#SWCTRL MASK for BT
	M_BTCX_RFSWMSK_WL_OFFSET				#SWCTRL MASK for WL
FEATURE_END
...
FEATURE_BEGIN[ampdu]
	...
	M_MIMO_MAXSYM
	M_WATCHDOG_8TU
	M_MAXRXFRM_LEN				#MAX Rx Frame len
FEATURE_END
...
FEATURE_BEGIN[bcntrim]
	...
	M_BCNTRIM_N_OFFSET				#Enable Disable Beacon Trim
	M_BCNTRIM_TIMEND_OFFSET			#Waiting time for TIM IE to end
	M_BCNTRIM_TSFTLRN_OFFSET			#TSF tolerance value (usecs)
	M_BCNTRIM_N_COUNTER_OFFSET		#PSM's local beacon trim counter
	M_BCNTRIM_RSSI_OFFSET				#Partial beacon RSSI
	M_BCNTRIM_CHANNEL_OFFSET			#Partial beacon channel
	M_BCNTRIM_SBCNRXED_OFFSET		#Self-BSSID beacon received
	M_BCNTRIM_CANTRIM_OFFSET			#Num of beacons which can be trimmed
	M_BCNTRIM_TRIMMED_OFFSET			# beacons which were trimmed
	M_BCNTRIM_BCNLENCNG_OFFSET		#beacons trimmed due to length change
	M_BCNTRIM_TSFADJ_OFFSET			#beacons not trimmed due to large TSF delta
