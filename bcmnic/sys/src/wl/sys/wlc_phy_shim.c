 ...
 *
 * $Id: wlc_phy_shim.c 613096 2016-01-16 03:43:49Z $
 */
...
void
wlapi_bmac_write_template_const_ram(wlc_phy_shim_info_t *physhim, int offset, int len,
		const void *buf)
{
	wlc_bmac_write_template_const_ram(physhim->wlc_hw, offset, len, buf);
}
