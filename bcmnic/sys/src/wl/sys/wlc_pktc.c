 ...
 *
 * $Id: wlc_pktc.c 613207 2016-01-18 06:00:27Z $
 */
...
static const bcm_iovar_t pktc_iovars[] = {
	...
	{"pktcbnd", IOV_PKTCBND, 0, IOVT_INT32, 0},
	{NULL, 0, 0, 0, 0}
};
...
static int wlc_pktc_doiovar(void *hdl, const bcm_iovar_t *vi, uint32 actionid, const char *name,
...
static int
wlc_pktc_doiovar(void *hdl, const bcm_iovar_t *vi, uint32 actionid, const char *name,
	void *params, uint p_len, void *arg, int len, int val_size, struct wlc_if *wlcif)
{
