 ...
 *
 * $Id: wlc_bsscfg_viel.c 613207 2016-01-18 06:00:27Z $
 */
...
static const bcm_iovar_t viel_iovars[] = {
	{"vndr_ie", IOV_VNDR_IE, IOVF_OPEN_ALLOW, IOVT_BUFFER, sizeof(int)},
	{NULL, 0, 0, 0, 0}
};
...
/* local declarations */
/* wlc module */
static int wlc_bsscfg_viel_doiovar(void *ctx, const bcm_iovar_t *vi, uint32 actionid,
...
#define wlc_bsscfg_viel_bss_dump NULL
...
BCMATTACHFN(wlc_bsscfg_viel_attach)(wlc_info_t *wlc)
{
	...
	if ((vieli->cfgh = wlc_bsscfg_cubby_reserve_ext(wlc, sizeof(vndr_ie_listel_t *),
			wlc_bsscfg_viel_bss_init, wlc_bsscfg_viel_bss_deinit,
			wlc_bsscfg_viel_bss_dump, 0,
			wlc_bsscfg_viel_bss_get, wlc_bsscfg_viel_bss_set,
			vieli)) < 0) {
...
/* iovar dispatch */
static int
wlc_bsscfg_viel_doiovar(void *ctx, const bcm_iovar_t *vi, uint32 actionid,
	const char *name, void *params, uint p_len, void *arg, int len,
	int val_size, struct wlc_if *wlcif)
{
