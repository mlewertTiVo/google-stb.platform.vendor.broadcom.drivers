 ...
 *
 * $Id: wlc_cubby.h 564579 2015-06-17 22:55:10Z $
 */
...
wlc_cubby_info_t *wlc_cubby_attach(wlc_info_t *wlc, obj_registry_key_t key, uint num);
void wlc_cubby_detach(wlc_info_t *wlc, wlc_cubby_info_t *cubby_info);
...
int wlc_cubby_init(wlc_cubby_info_t *cubby_info, void *obj,
	cubby_sec_set_fn_t fn, void *set_ctx);
void wlc_cubby_deinit(wlc_cubby_info_t *cubby_info, void *obj,
	cubby_sec_get_fn_t fn, void *sec_ctx);
