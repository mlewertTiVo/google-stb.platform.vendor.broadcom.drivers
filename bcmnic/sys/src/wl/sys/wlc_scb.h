 ...
 *
 * $Id: wlc_scb.h 606067 2015-12-14 08:25:18Z $
 */
 ...
 */
int wlc_scb_cubby_reserve_fn(wlc_info_t *wlc, uint size, scb_cubby_init_t fn_init,
	scb_cubby_deinit_t fn_deinit, scb_cubby_secsz_t fn_secsz,
	scb_cubby_dump_t fn_dump, void *context);
#define wlc_scb_cubby_reserve(wlc, size, fn_init, fn_deinit, fn_dump, ctx) \
	wlc_scb_cubby_reserve_fn(wlc, size, fn_init, fn_deinit, NULL, fn_dump, ctx)
#define wlc_scb_cubby_reserve_ext(wlc, size, fn_init, fn_deinit, fn_secsz, fn_dump, ctx) \
	wlc_scb_cubby_reserve_fn(wlc, size, fn_init, fn_deinit, fn_secsz, fn_dump, ctx)
