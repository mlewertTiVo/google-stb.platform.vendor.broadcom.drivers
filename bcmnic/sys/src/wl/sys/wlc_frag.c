 ...
 *
 * $Id: wlc_frag.c 568191 2015-07-01 22:15:26Z $
 */
...
BCMATTACHFN(wlc_frag_attach)(wlc_info_t *wlc)
{
	...
	if ((frag->scbh = wlc_scb_cubby_reserve_ext(wlc, sizeof(scb_frag_t *),
			wlc_frag_scb_init, wlc_frag_scb_deinit,
			wlc_frag_scb_secsz, wlc_frag_scb_dump, frag)) < 0) {
