 ...
 *
 * $Id: wlc_sup.c 612351 2016-01-13 16:52:50Z $
 */
...
BCMATTACHFN(wlc_sup_attach)(wlc_info_t *wlc)
{
	...
	if ((sup_info->cfgh = wlc_bsscfg_cubby_reserve_ext(wlc, sizeof(supplicant_t *),
...
wlc_sup_ulp_enter_cb(void *handle, ulp_ext_info_t *einfo, uint8 *cache_data)
{
	...
	ULP_DBG(("%s: cache_shm: %p\n", __FUNCTION__, (wlc_sup_p1_cubby_info_t *)cache_data));
