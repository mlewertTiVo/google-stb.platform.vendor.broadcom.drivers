 ...
 *
 * $Id: wlc_bsscfg.h 595398 2015-10-27 13:47:54Z $
 */
...
#ifdef WL_NAN
#define BSSCFG_NAN(cfg) ((cfg) && ((cfg)->type == BSSCFG_TYPE_NAN))
#else
 ...
 */
#define wlc_bsscfg_cubby_reserve(h, s, i, d, u, c) \
	wlc_bsscfg_cubby_reserve_ext(h, s, i, d, u, 0, NULL, NULL, c)
#define wlc_bsscfg_cubby_reserve_ext(h, s, i, d, u, f, r, w, c)	\
	wlc_bsscfg_cubby_reserve_fn(h, s, i, d, u, f, r, w, c)
extern int wlc_bsscfg_cubby_reserve_fn(wlc_info_t *wlc, uint size,
