 ...
 *
 * $Id: wlc_auth.c 600056 2015-11-17 18:09:05Z $
 */
...
BCMATTACHFN(wlc_auth_attach)(wlc_info_t *wlc)
{
	...
	auth_info->cfg_handle =
	        wlc_bsscfg_cubby_reserve(wlc, sizeof(authenticator_t *), wlc_auth_bss_init,
	                                 wlc_auth_bss_deinit, NULL, auth_info);
