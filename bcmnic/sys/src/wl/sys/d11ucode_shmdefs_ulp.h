 ...
 *
 * $Id: /tmp/tmpFX5Uhj/ucode_checkout/tot_1101_0/build/d11ucode_shmdefs_ulp.h Jan. 14, 2016 07:33:26 PM <junseok> $
 */
// COMMON SHMS
...
#endif /* (D11_REV == 46) */
#if (D11_REV == 60)
#define	M_SR_TBTT_L	(0xa9e*2)
#define	M_SR_TBTT_H	(0xa9f*2)
...
#define	M_DRVR_UCODE_IF_BLK	(0xaa6*2)
...
#define	M_DRIVER_BLOCK_SIZE	512
...
#define	M_TSF_ADJ_GTS_TSFTMR_WD0	(0xd7f*2)
#define	M_TSF_ADJ_GTS_TSFTMR_WD1	(0xd94*2)
#define	M_TSF_ADJ_GTS_TSFTMR_WD2	(0xd95*2)
#define	M_TSF_ADJ_GTS_TSFTMR_WD3	(0xd96*2)
#define	M_TSF_ADJ_OFFSET_TIMER	(0xd97*2)
#define	M_TSF_ADJ_GTS_SLOW_TMR_L	(0xd98*2)
#define	M_TSF_ADJ_GTS_SLOW_TMR_H	(0xd99*2)
#define	M_TSF_ADJ_OFFSET_PER	(0xd9a*2)
#define	M_BCNTRIM_DBG_BLK	(0xd9c*2)
...
#define	M_SMPL_COL_BMP	(0xd9b*2)
#define	M_SMPL_COL_CTL	(0xda8*2)
#define	M_SLOW_CTL_SR	(0xda9*2)
#define	M_PMU_FCBS_BLK	(0xdaa*2)
...
#define	M_TXERR_TXOFF	(M_DEBUG_BLK+(0xe*2))
#define	M_TXERR_TXOFF_OFFSET	(0xe*2)
#define	M_TXERR_PSDULEN	(M_DEBUG_BLK+(0xf*2))
#define	M_TXERR_PSDULEN_OFFSET	(0xf*2)
#define	M_DS1_SCR_SAVE_BLK	(0xdbe*2)
#define	M_DS1_SCR_SAVE_BLK_SIZE	64
#define	M_NON_FCBS_EXIT_DEBUG	(0xdfe*2)
#define	M_NON_FCBS_EXIT_DEBUG_CMD_PTR	(0xdff*2)
#define	M_NON_FCBS_EXIT_DEBUG_DAT_PTR	(0xe00*2)
#define	M_FCBS_EXIT_DEBUG	(0xe01*2)
#define	M_FCBS_EXIT_DEBUG_CMD_PTR	(0xe02*2)
#define	M_FCBS_EXIT_DEBUG_DAT_PTR	(0xe03*2)
#define	M_ONE_TIME_CFG_BM	(0xe04*2)
#define	M_DSX_TST_MODE	(0xe05*2)
#define	M_FRRUN_LBCN_CNT	(0xe06*2)
#define	M_DS1_KA_CFG	(0xe07*2)
#define	M_DS1_KA_CTR	(0xe08*2)
#define	M_DS1_KA_NUM	(0xe09*2)
#define	M_DS1_KA_IPG	(0xe0a*2)
#define	M_AWK_RSN_CD	(0xe0b*2)
#define	M_AWK_RSN_CTRL	(0xe0c*2)
#define	M_DS1_CTRL_STATUS	(0xe0d*2)
#define	M_DS1_CTRL_SDIO	(0xe0e*2)
#define	M_DS1_CTRL_SDIO_OOB_H	(0xe0f*2)
#define	M_DS1_CTRL_SDIO_OOB_L	(0xe10*2)
#define	M_DS1_CTRL_SDIO_OOBTH	(0xe11*2)
#define	M_DS1_CTRL_JTAG	(0xe12*2)
#define	M_DS1_CTRL_JTAG_OOB_H	(0xe13*2)
#define	M_DS1_CTRL_JTAG_OOB_L	(0xe14*2)
#define	M_DS1_CTRL_JTAG_OOBTH	(0xe15*2)
#define	M_DS1_CTRL_SDIO_PIN	(0xe16*2)
#define	M_DS1_CTRL_JTAG_PIN	(0xe17*2)
#define	M_DS1_CTRL_FUNCAL	(0xe18*2)
#define	M_DS1_ENTER_OOBJ	(0xe19*2)
#define	M_DS1_DIS_OOBJ	(0xe1a*2)
#define	M_HUDI_DS1SLP_CTR	(0xe1b*2)
#define	M_JTAG_DS1SLP_CTR	(0xe1c*2)
#define	M_HUDI_MNPOLL_CTR	(0xe1d*2)
#define	M_HUDI_PM_CTR	(0xe1e*2)
#define	M_HUDI_NO_ACTION	(0xe1f*2)
#endif /* (D11_REV == 60) */
