...
###################################################################
export LINUXVER=3.14.28-1.11pre
export LINUX_VERSION=3_14_28
export KERNELDIR=/home/ytpark/projects/android/STB
export CROSSTOOL=${KERNELDIR}/stbgcc-4.8-1.4/bin
export PATH=${CROSSTOOL}:$PATH
export PATH=${TOOLCHAIN}/bin:$PATH
export LINUXDIR=${KERNELDIR}/stblinux-3.14.28-1.11pre/linux
export ROOTDIR=${KERNELDIR}/stblinux-3.14.28-1.11pre/rootfs
