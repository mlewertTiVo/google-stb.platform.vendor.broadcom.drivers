...
#
# $Id: epivers.sh 542461 2015-03-19 22:22:54Z $
#
...
if [ -f epivers.h ]; then
	...
	SVNURL='$HeadURL: svn://wlan-sj1-svn01.sj.broadcom.com/svn/wlansvn/proj/branches/EAGLE_TWIG_10_10_84/src/include/epivers.sh $'
