 ...
 *
 * $Id: wlc_scb_ratesel.c 613452 2016-01-19 03:04:16Z $
 */
...
uint8
wlc_scb_ratesel_getbwcap(wlc_ratesel_info_t *wrsi, struct scb *scb, uint8 ac)
{
	rcb_t *state;
	...
	return wlc_ratesel_getbwcap(state);
}
