 ...
 *
 * $Id: wlc_assoc.c 628391 2016-03-30 22:28:59Z $
 */
...
#define WECA_ASSOC_TIMEOUT	3000	/* qt is slow */
#define WLC_IE_WAIT_TIMEOUT	3000	/* assoc. ie waiting timeout in ms */
#define WECA_AUTH_TIMEOUT	3000	/* authentication timeout in ms */
#else
...
{
			static uint32 gcal = 1;

			/* only run full call once */
			if (gcal == 1) {
				gcal = 0;
