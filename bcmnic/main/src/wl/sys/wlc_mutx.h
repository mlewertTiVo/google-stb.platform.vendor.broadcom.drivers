 ...
 *
 * $Id: wlc_mutx.h 613452 2016-01-19 03:04:16Z $
 */
...
void wlc_mutx_update_txcounters(wlc_mutx_info_t *mu_info, struct scb *scb,
      ratespec_t rspec, bool is_mu, bool txs_mu, uint16 ncons, uint16 nlost, uint8 gid);
#endif /* WLCNT */
...
#endif /* WL_PSMX */
uint32 wlc_mutx_bw_policy_update(wlc_mutx_info_t *mu_info);
uint32 wlc_mutx_bw_policy(wlc_mutx_info_t *mu_info);
#endif   /* _wlc_mutx_h_ */
