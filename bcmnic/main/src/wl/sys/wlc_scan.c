 ...
 *
 * $Id: wlc_scan.c 634137 2016-04-26 22:13:07Z $
 */
...
#undef WLC_SCAN_ASSOC_TIME
#define WLC_SCAN_ASSOC_TIME 60
#else
...
/* HACKHACK - increase the dwell time */
scan_info->nprobes = 2;
scan_info->active_time = 100;
scan_info->passive_time = 200;
...
wlc_scan_return_home_channel(scan_info_t *scan_info)
{
	...
	wlc_bsscfg_t *cfg;
#endif
#if defined(WLMSG_SCAN) || defined(SCANOL)
	char chanbuf[CHANSPEC_STR_LEN];
	chanbuf[0] = '\0';
#endif
