 ...
 *
 * $Id: wlc.h 626171 2016-03-18 23:02:47Z $
 */
...
#define WLC_BCN_TIMEOUT		600	/* VELOCE is very slow, set for 10min */
...
#if defined(BCM7271_EMU)
	bool		ucode_loaded;	/* Ucode download state copy */
#endif /* defined(BCM7271_EMU) */
...
#if defined(BCM7271_EMU)
#define WLC_RFAWARE_LIFETIME_DEFAULT	8000	/* QT and EMULATION */
#define WLC_EXPTIME_END_TIME			30000
#else /* !(defined(BCM7271_EMU)) */
