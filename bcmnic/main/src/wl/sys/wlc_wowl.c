 ...
 *
 * $Id: wlc_wowl.c 643457 2016-06-14 21:33:24Z $
 */
...
wlc_wowl_ucode_init(wlc_info_t *wlc, struct scb *scb)
{
	...
	if (key_info.hw_algo == WSEC_ALGO_AES) {
		...
		else if (D11REV_IS(wlc->pub->corerev, 65) && WLCISACPHY(wlc->band)) {
			ret = wlc_wowl_dnld_ucode_inits(wlc_hw, d11aeswakeucode65,
			d11aeswakeucode65sz, d11wakeac33initvals65, d11wakeac33bsinitvals65);
		}
		...
		if (D11REV_IS(wlc->pub->corerev, 12))
			...
			ret = wlc_wowl_dnld_ucode_inits(wlc_hw, d11ucode_wowl65, d11ucode_wowl65sz,
				d11wakeac33initvals65, d11wakeac33bsinitvals65);
                }
		else if (D11REV_GE(wlc->pub->corerev, 42) && WLCISACPHY(wlc->band)) {
