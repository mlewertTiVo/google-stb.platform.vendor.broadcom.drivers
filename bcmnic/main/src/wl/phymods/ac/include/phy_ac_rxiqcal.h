...
typedef struct _acphy_20696_rxcal_radioregs {
	bool   is_orig;
	...
	uint16 logen_core_reg0[PHY_CORE_MAX];
	uint16 logen_core_ovr0[PHY_CORE_MAX];
	uint16 tx2g_mix_reg0[PHY_CORE_MAX];
	uint16 tx2g_misc_cfg1[PHY_CORE_MAX];
	uint16 txdac_reg0[PHY_CORE_MAX];
	uint16 rx2g_cfg1_ovr[PHY_CORE_MAX];
	uint16 rx2g_reg1[PHY_CORE_MAX];
	uint16 lna2g_reg1[PHY_CORE_MAX];
	uint16 lna2g_reg2[PHY_CORE_MAX];
	uint16 rx2g_reg3[PHY_CORE_MAX];
	uint16 tx5g_misc_cfg1[PHY_CORE_MAX];
	uint16 tx5g_mix_reg0[PHY_CORE_MAX];
	uint16 rx5g_cfg1_ovr[PHY_CORE_MAX];
	uint16 rx5g_reg1[PHY_CORE_MAX];
	uint16 rx5g_reg2[PHY_CORE_MAX];
	uint16 rx5g_reg4[PHY_CORE_MAX];
	uint16 rx5g_reg5[PHY_CORE_MAX];
} acphy_20696_rxcal_radioregs_t;
