...
#define USE_HW_MINORVERSION(phy_rev) (ACREV_IS(phy_rev, 12) || \
                                     (ACREV_GE(phy_rev, 32) && !ACREV_IS(phy_rev, 37)))
...
#define ACMAJORREV_33(phy_rev) \
	(ACREV_IS(phy_rev, 33) || ACREV_IS(phy_rev, 37))
...
#define SW_ACMINORREV_4(phy_rev) \
	(ACREV_IS(phy_rev, 14) || ACREV_IS(phy_rev, 20) || ACREV_IS(phy_rev, 37))
...
/* 4365 (20693) but not 7271 (20696) */
#define PHY_AS_80P80_CAP(pi) \
	(ACMAJORREV_33(pi->pubpi.phy_rev) && (RADIOID(pi->pubpi.radioid) == BCM20693_ID))
/* ********************************************************************* */
...
#ifdef BCM7271
#undef ACREV32
#define  ACREV32 (pi->sh->chip == BCM4365_CHIP_ID || pi->sh->chip == BCM4366_CHIP_ID || \
		 pi->sh->chip == BCM7271_CHIP_ID)
#endif /* BCM7271 */
#endif /* BCMCHIPID */
#else
#define ACREV0 0
...
#define ACPHY_GAIN_DELTA_ELNA_OFF_43012 3
...
#define READ_RADIO_REGFLD_28NM(pi, regpfx, regnm, core, fldname) \
	((RADIOID_IS((pi)->pubpi->radioid, BCM2069d_ID)) \
		? READ_RADIO_REGFLD_20694(pi, regpfx, regnm, core, fldname) : \
	 (RADIOID_IS((pi)->pubpi->radioid, BCM2069d_ID)) \
		? READ_RADIO_REGFLD_20695(pi, regpfx, regnm, core, fldname) : \
	 (RADIOID_IS((pi)->pubpi->radioid, BCM2069d_ID)) \
		? READ_RADIO_REGFLD_20696(pi, regpfx, regnm, core, fldname) : 0)
...
#define MOD_RADIO_REG_28NM(pi, regpfx, regnm, core, fldname, value) \
	...
	(RADIOID((pi)->pubpi.radioid) == BCM20695_ID) \
	? MOD_RADIO_REG_20695(pi, regpfx, regnm, core, fldname, value) : \
	(RADIOID((pi)->pubpi.radioid) == BCM20696_ID) \
	? MOD_RADIO_REG_20696(pi, regnm, core, fldname, value) : BCM_REFERENCE(pi)
