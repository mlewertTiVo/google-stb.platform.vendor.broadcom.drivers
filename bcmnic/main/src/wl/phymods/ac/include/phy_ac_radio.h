...
/* 20696 Radio functions */
typedef enum {
	RADIO_20696_FAST_ADC,
	RADIO_20696_SLOW_ADC
} radio_20696_adc_modes_t;
...
extern void wlc_phy_chanspec_radio20696_setup(phy_info_t *pi, uint8 ch, 
...
#define ADC_CAL_CAL_MODE_BYPASS		0
#define ADC_CAL_CAL_MODE_PARALLEL	1
#define ADC_CAL_CAL_MODE_SEQUENTIAL	2
extern void wlc_phy_radio20696_adc_cap_cal(phy_info_t *pi, int mode);
extern void wlc_phy_radio20696_adc_offset_gain_cal(phy_info_t *pi);
extern void wlc_phy_radio20696_apply_adc_cal_result(phy_info_t *pi);

#define TXDAC_BW_SETUP_DACLOAD_LPF	0
#define TXDAC_BW_SETUP_DACLOAD_GM	1
extern void wlc_phy_radio20696_txdac_bw_setup(phy_info_t *pi, int dacload);
