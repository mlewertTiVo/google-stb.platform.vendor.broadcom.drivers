...
$(intermediates)/epivers.h:
	cp $(BCM_MY_LOCAL_PATH)/src/include/epivers.h.in $(BCM_MY_LOCAL_PATH)/src/include/epivers.sh $(MY_INTERMEDIATES) && pushd $(MY_INTERMEDIATES) && bash epivers.sh && popd
