 ...
 *
 * $Id: wlc_phy_lcn40.h 630712 2016-04-11 19:05:53Z kentryu $*
 */
...
/* ********************************************************* */
	...
	phy_lcn40_misc_info_t *misci;
	phy_lcn40_chanmgr_info_t *chanmgri;
	phy_lcn40_btcx_info_t *btcxi;
	phy_lcn40_txiqlocal_info_t *txiqlocali;
	phy_lcn40_lpc_info_t *lpci;
	phy_lcn40_temp_info_t *tempi;
/* ********************************************************* */
...
void wlc_phy_chanspec_set_lcn40phy(phy_info_t *pi, chanspec_t chanspec);
extern void wlc_lcn40phy_set_tx_pwr_ctrl(phy_info_t *pi, uint16 mode);
void wlc_lcn40phy_set_tx_pwr_by_index(phy_info_t *pi, int indx);
/* ********************** REMOVE ********************* */
