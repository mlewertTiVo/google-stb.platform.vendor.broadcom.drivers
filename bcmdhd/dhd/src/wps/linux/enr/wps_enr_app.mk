...
ifeq ($(STBLINUX),1)
CFLAGS += -fno-strict-aliasing -Werror -Wno-unused-but-set-variable
else
...
export INCLUDE =  -I$(SRCBASE)/include -I$(SRCBASE)/../components/shared -I../../common/include -I../inc -I$(SRCBASE)/shared/bcmwifi/include
