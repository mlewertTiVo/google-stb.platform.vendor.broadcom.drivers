 ...
 *
 * $Id: nan.h 633595 2016-04-23 11:15:47Z $
 */
#ifndef _NAN_H_
#define _NAN_H_
...
enum {
	...
	/* nan 2.0 */
	NAN_ATTR_NAN_MGMT	= 14,	/* NAN Mgmt Attr (TBD; not in spec yet) */
	NAN_ATTR_NAN_NDP	= 15,	/* NAN NDP Attr */
	NAN_ATTR_NAN_DEV_CAP	= 16,	/* NAN Device Capability */
	NAN_ATTR_NAN_AVAIL	= 17,	/* NAN Availability Attr */
