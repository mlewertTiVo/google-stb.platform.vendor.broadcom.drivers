 ...
 *
 * $Id: wlc_phy_int.h 524316 2015-01-06 13:54:20Z $
 */
...
typedef struct  {
	...
	struct {
		...
		bool need_ofdm_desense;
		bool need_bphy_desense;
...
#endif
#if defined(WL_SARLIMIT) || defined(BCM_OL_DEV)
...
extern void wlc_phy_tof_acphy(phy_info_t *pi, bool enter, bool hw_adj);
extern int wlc_phy_tof_info_acphy(phy_info_t *pi, int* frame_typep, int* frame_bwp, int8* rssip);
extern void wlc_phy_tof_cmd_acphy(phy_info_t *pi, bool seq);
extern int wlc_phy_tof_kvalue_acphy(phy_info_t *pi, chanspec_t chanspec, uint32 *kip, uint32 *ktp);
#endif
/* ************* Remove ************* */
