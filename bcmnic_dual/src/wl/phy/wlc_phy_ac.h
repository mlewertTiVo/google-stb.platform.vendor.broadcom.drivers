 ...
 *
 * $Id: wlc_phy_ac.h 481586 2014-05-29 21:55:20Z $
 */
...
#define ACMINORREV_0(phy_rev) \
	(ACREV_IS(phy_rev, 0) || ACREV_IS(phy_rev, 2) || ACREV_IS(phy_rev, 3) || \
	 ACREV_IS(phy_rev, 4) || ACREV_IS(phy_rev, 10) || ACREV_IS(phy_rev, 12))
...
#define ACMINORREV_2(phy_rev) \
	(ACREV_IS(phy_rev, 6) || ACREV_IS(phy_rev, 9) || ACREV_IS(phy_rev, 11))
