...
wlc_tdls_bsscfg_create(wlc_info_t *wlc, wlc_bsscfg_t *parent, bool initiator)
{
	...
	/* Set the TDLS bsscfg->wsec to AES for any security OR set to "no security"
	 * When Parent wsec is "no security" or "MFP" (with MFP feature enabled).
	 */
	...
	{
		WL_INFORM(("Setting TDLS bsscfg->wsec to 'No Secuity', "
		           "When Parent wsec is 'No Secuity' or 'MFP'\n"));
		bsscfg->wsec = 0;
	}
